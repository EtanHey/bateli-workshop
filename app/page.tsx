...
export default function Home() {
  return (
    <main dir='rtl' className='w-full -z-[9999] gap-3 flex bg-white flex-col relative h-fit text-center'>
      <HeroImage />
      {/* <Image unoptimized className='-z-50 object-contain object-top' src='/page_background.webp' alt='background' fill priority /> */}
      <Image unoptimized className='-z-50 object-contain' src='/page_background.webp' alt='background' fill priority />
